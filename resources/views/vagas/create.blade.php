...
@section('contentheader_description')
  {{ 'Preencha os dados abaixo e cadastre uma nova oportunidade!' }}
@endsection
    ...
    <div class="col-lg-12">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Cadastro de Vagas</h3>
        </div>
        <div class="box-body">
          ...
          <form class="form-horizontal" method="POST" action="{{ route('vagas.cadastrar') }}">
            {{ csrf_field() }}
            <div align="center">
              <h4>Dados Básicos</h4>
              <hr/>
